...
struct ReminderFilterView: View {
    
    @State private var selectedReminder: Reminder?
    @State private var showReminderDetail: Bool = false
    @State private var loading: Bool = false
    
    @ObservedObject private var reminderFilterViewModel: ReminderFilterViewModel
                    
    init(vm: ReminderFilterViewModel) {
        reminderFilterViewModel = vm
    }
    ...
    private func deleteReminder(_ indexSet: IndexSet) {
        indexSet.forEach { index in
            let reminder = reminderFilterViewModel.reminders[index]
            do {
    ...
    var body: some View {
        ...
        VStack {
            List {
                if !loading {
                    ForEach(reminderFilterViewModel.reminders,id: \.self) { reminder in
